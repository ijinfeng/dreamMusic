...
class PersonalFMToolBar extends StatelessWidget with EasyInterface {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<PersonalFMStateModel, SingleSongModel?>(
      selector: (p0, p1) => p1.getPlaySong,
          ...
          children: [
            Selector<AppSharedManager, int>(
              ...
              builder: (context, value, child) {
                final like =
                    AppSharedManager().isLikeSong(model?.track?.id ?? 0);
            ...
            Selector<SongPlayer, bool>(
              selector: (p0, p1) =>
                  p1.playing && p1.playType == PlayType.personlFM,
              builder: (context, value, child) {
                return CustomTooltipWidget(
                  message: value ? "暂停" : "播放",
                  child: SelectableIconButton(
