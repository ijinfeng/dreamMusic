  ...
  List<List<LeftMenuItemModel>> get itemModels => [
        [
          LeftMenuItemModel(
              ...
              title: '发现音乐',
              name: LeftMenuItemName.find),
          LeftMenuItemModel(
              icon: 'assets/leftmenu/my_icn_fm.png',
              title: '私人FM',
              name: LeftMenuItemName.personal),
        ],
        [
          LeftMenuItemModel(
              icon: 'assets/leftmenu/my_icn_like.png',
              title: '我喜欢的音乐',
              name: LeftMenuItemName.mylike),
          LeftMenuItemModel(
              icon: 'assets/leftmenu/my_icn_fav.png',
              title: '我收藏的歌单',
              name: LeftMenuItemName.mycollection),
          LeftMenuItemModel(
              icon: 'icon_download.png',
              title: '我的下载',
              name: LeftMenuItemName.mydownload)
        ],
        [
          LeftMenuItemModel(
              icon: 'assets/leftmenu/my_icn_setting.png',
              title: '设置',
              name: LeftMenuItemName.setting)
        ],
        if (kDebugMode)
          [
            LeftMenuItemModel(
                icon: 'icon_test.png', title: '测试', name: LeftMenuItemName.test)
          ]
      ];
